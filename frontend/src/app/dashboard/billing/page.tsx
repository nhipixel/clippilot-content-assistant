...
const plans: PricingPlan[] = [
  {
    title: "Small Pack",
    price: "$3.99",
    description: "Perfect for small non-profits and individuals",
  ...
  },
  {
    title: "Medium Pack",
    price: "$9.99",
    description: "Best value for regular non-profits",
  ...
  },
  {
    title: "Large Pack",
    price: "$29.99",
    description: "Ideal for large scale non-profits and agencies",
    ...
    <div className="mx-auto flex flex-col space-y-8 px-4 py-12">
      <div className="relative flex items-center justify-center gap-4">
        ...
        <div className="space-y-2 text-center">
          ...
          <p className="text-muted-foreground">
            Purchase credits to generate more testimony clips. The more credtis
      ...
      <div className="bg-muted/50 rounded-lg p-6">
        ...
        <ul className="text-muted-foreground list-disc space-y-2 pl-5 text-sm">
          <li>1 credit = 1 minute of video processing</li>
          <li>
            The program will create around 1 clip per 5 minutes of video length
          </li>
          <li>Credits never expire and can be used anytime</li>
          <li>Longer testimonies require more credits based on duration</li>
